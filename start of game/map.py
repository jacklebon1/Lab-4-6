...
south and east. The exit is to the west.""", "exits": {"south":"Admins", "west":"Parking", "east":"Tutor"}}

room_admins = {"name":"MJ and Simon's room", "description":"""You are leaning against the door of the systems managers'
room. Inside you notice Matt "MJ" John and Simon Jones. They
ignore you. To the north is the reception.""", "exits": {"north":"Reception"}}
